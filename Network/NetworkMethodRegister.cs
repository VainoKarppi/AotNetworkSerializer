...
public static partial class MessageBuilder {
    public static class Methods {
                ...
                var del = Delegate.CreateDelegate(
                    Expression.GetDelegateType(
                        method.GetParameters()
                              ...
                              .Concat(method.ReturnType == typeof(void) ? Array.Empty<Type>() : new[] { method.ReturnType })
                              .ToArray()
                    ),
                    method
                );
        ...
        public static T? CallServerMethod<T>(string methodName, params object[] args) {
        ...
        public static T? CallClientMethod<T>(string methodName, params object[] args) {
